...
describe('loraDialogOpenFolderIconPath', () => {
  it('exposes the tabler folder path', () => {
    expect(loraDialogOpenFolderIconPath).toBe(
  ...
  it('exposes the folder icon size', () => {
    expect(loraDialogOpenFolderIconSize).toBe(19.2);
  });
});
